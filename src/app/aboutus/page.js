    ...
    return (
        <>
            <body className="font-inter text-base text-slate-950 dark:text-white dark:bg-slate-900">
                <Navbar />
                <section className="py-16 md:py-24 lg:py-28 w-full table relative bg-[url('/images/bg/bg-5.jpg')] bg-center bg-cover bg-no-repeat"
                    id="home">
                    <div className="absolute inset-0 bg-slate-950/80"></div>

                    <div className="container">
                        <div className="grid grid-cols-1 pb-8 text-center mt-4 md:mt-10">
                            <h3 className="font-medium leading-normal text-2xl md:text-3xl mt-4 md:mt-10 text-white font-lexend">Company Story</h3>
                        </div>
                    </div>
                </section>
