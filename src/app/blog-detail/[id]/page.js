            ...
            <section className="py-16 md:py-24 lg:py-28 w-full table relative bg-[url('/images/bg/bg-5.jpg')] bg-center bg-cover bg-no-repeat" id="home">
                ...
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center mt-4 md:mt-10">
                        <h3 className="mb-3 font-medium leading-normal text-2xl md:text-3xl mt-4 md:mt-10 text-white">Introducing new tools for your design.</h3>

                        <ul className="list-none mt-4 md:mt-6">
                            <li className="inline-block text-white/50 mx-2 md:mx-5"> <span className="text-white block">Client :</span> <span className="block">Calvin Carlo</span></li>
                            <li className="inline-block text-white/50 mx-2 md:mx-5"> <span className="text-white block">Date :</span> <span className="block">15th August 2022</span></li>
                            <li className="inline-block text-white/50 mx-2 md:mx-5"> <span className="text-white block">Time :</span> <span className="block">8 Min Read</span></li>
                        </ul>
                    </div>
                </div>
            </section>
