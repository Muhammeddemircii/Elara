...
const resources = {
  en: {
    translation: {
      ...
      "whyElaraContent2": "Zero Carbon Footprint – An environmentally friendly farming model",
      "whyElaraContent3": "Renewable Energy Usage – Sustainable production with geothermal energy",
      "whyElaraContent4": "Berry Group Expertise – Delicious and nutritious fruits",
      "whyElaraContent5": "Global Trade – Local production, access to global markets",
      "whyElaraContent6": "Respect for Nature and the Future – A commitment to eco-friendly and sustainable agriculture",
  ...
  tr: {
    translation: {
      ...
      "whyElaraContent2": "Sıfır Karbon Ayak İzi – Doğayı koruyan tarım modeli",
      "whyElaraContent3": "Yenilenebilir Enerji Kullanımı – Jeotermal enerjiyle sürdürülebilir üretim",
      "whyElaraContent4": "Berry Grubu Uzmanlığı – Lezzetli ve besleyici meyveler",
      "whyElaraContent5": "Küresel Ticaret – Yerel üretim, dünya pazarlarına açılım",
      "whyElaraContent6": "Doğaya ve Geleceğe Saygı – Çevreci ve sürdürülebilir tarım anlayışı",
